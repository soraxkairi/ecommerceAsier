        ...
        <header className="mb-8 border-b">
            <div className="flex items-center justify-between mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl">
                <Link href="/">
                    ...
                    Instant<span className="text-primary font-semibold"><span className="text-green-500">Games</span></span>
                    </h1>
                </Link>
                ...
                <div className="flex divide-x border-r sm:border-l">
                    <Button variant={"outline"} onClick= {() => handleCartClick()}className="flex flex-col gap-y-1.5 h-12 w-12 sm:h20 sm:w-20 md:h-24 md:w-24 rounded-none">
                        <ShoppingBag />
